...
| Row resize (G2) | `enableRowResize` | engine | boolean | false | custom — per-cell bottom drag handle → per-row height (local state); double-click resets; in settings sheet ("Rows") | ✅ done |
